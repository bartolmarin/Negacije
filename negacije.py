...
prozor=Tk()
prozor.title('Negacije')
prozor.config(width=1500, height=900)
prozor.resizable(True, True)

o1=Label(prozor,text="Negacije - rečenice iskazane prirodnim jezikom i jezikom logike prvog reda",font=("Roboto", 25))
o1.place(x=450,y=50)
o2=Label(prozor,text="Zadana je rečenica:",font=("Roboto", 13))
o2.place(x=50,y=300)
ob=Label(prozor,text="Napišite negaciju rečenice koja je zadana: ",font=("Roboto", 13))
ob.place(x=50, y=350)
...
kv=open(resource_path('kvantificirane.txt'), 'r', encoding="UTF8")
sadrzajkv=kv.read()
nkv=open(resource_path('kvantificiranenegacije.txt'), 'r', encoding="UTF8")
sadrzajnkv=nkv.read()
p=open(resource_path('prirodne.txt'), 'r', encoding="UTF8")
sadrzajp=p.read()
np=open(resource_path('prirodnenegacije.txt'), 'r', encoding="UTF8")
sadrzajnp=np.read()
...
def pnp():
    def glavno():
        ...
        lista1=list(map(str,sadrzajp.splitlines()))
    ...
    def rezultat():    
        ...
        lista2=list(map(str,sadrzajnp.splitlines()))
...
def kvnkv():
    def glavno():
        ...
        odaberi=randint(1,182)
        lista1=[]
        lista1=list(map(str,sadrzajkv.splitlines()))
        zadatak=lista1[odaberi]
        ozadatak=Label(prozor,text=str(zadatak),font=("Roboto",15))
        ozadatak.place(x=250,y=300)
    ...
    def rezultat():    
        ...
        f.write("Vaš odgovor je: "+ "\""+str(odgovor)+"\""+'\n')
        #Traži očekivani odgovor
        lista2=list(map(str,sadrzajnkv.splitlines()))
        ocekivaniOdgovor=lista2[odaberi]
...
lprob=Button(prozor, text="Prirodni - prirodni", font=("Roboto",13), command=pnp)
lprob.place(x=480,y=150)

oblpr=Button(prozor, text="Lpr - Lpr", font=("Roboto",13),command=kvnkv)
